    ...
    <div class="card border-0 text-dark" id="manage_categories">
        <nav>
            <div class="nav nav-tabs nav-fill border-0" id="nav-tab" role="tablist">
                <a class="nav-item nav-link active rounded-0 border-0 py-3" id="add-cat-tab" data-toggle="tab" href="#add-cat"
                    role="tab" aria-controls="nav-home" aria-selected="true"> <b> Add Category </b> </a>
                <a class="nav-item nav-link rounded-0 border-0 py-3" id="del-cat-tab" data-toggle="tab" href="#del-cat" role="tab"
