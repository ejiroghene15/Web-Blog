...
<head>
    ...
    <title>@yield( "title", "Gisthub | $article->title")</title>
                            ...
                            <article class="card border-0">
                                ...
                                <section class=" card-header">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="d-inline-block pl-2 w-100 author">
                                            ...
                                            <p class="m-0">{{ date("D jS F Y ", strtotime($article->created_at))}}</p>
                                        </div>
                                    </div>
                                </section>
                                ...
                                <div class="card-body py-3 pb-0 d-flex justify-content-between">
                                    ...
                                    <a class="btn btn-sm btn-info gh-btn align-self-baseline"
                                        ...
                                        href="{{ route('edit_post', ['title' => str_replace(' ', '-', $article->title) ]) }}">Edit
                                        post</a>
                                    @endcan
                                </div>
                                ...
                                <div class="card-body pt-2">
                                    ...
                                    <form method="post">
                                        @csrf
                                        <details open>
                                            <summary class="border-0 text-dark"><label for="">Leave a Comment</label>
                                            </summary>
                                            @error('comment')
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <section for="comment">
                                            ...
                                            <h6 style="font-size: 14px">
                                                <span
                                                    class="fa fa-clock-o mr-1"></span>{{date("d-m-y @ h:ia ", strtotime($comment->date))}}
                                            </h6>
                                        </section>
                                    </div>
