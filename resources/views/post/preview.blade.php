        ...
        <div class="col-md-4 my-md-0 my-5">
            <form action="" method="post" class="card bg-dark">
                ...
                <div class="card-body">
                    ...
                    <button type="submit" name="action" value="approve" class="btn btn-sm btn-success">Approve
                        post</button>

                    <button type="submit" name="action" value="reject" class="btn btn-sm btn-danger">Reject
                        post</button>
                </div>
            </form>
        </div>
