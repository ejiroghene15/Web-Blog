...
<html>
    ...
    <head>
        ...
        <meta property="og:title" content="{{ Str::lower($article->title) }}" />
        ...
        <title>@yield( "title", config('app.name') ." | {{ Str::camel($article->title) }}")</title>
                            ...
                            <div class="article">
                                <article class="card border-0">
                                    ...
                                    <section class=" card-header">
                                        <div class="d-flex justify-content-between align-items-start mb-1 py-2">
                                        ...
                                        <div class="d-flex mb-2">
                                            <img src="{{$article->user->profilepix}}" class="rounded-circle" height="40"
                                                width="40">
                                    ...
                                    <div class="card-body py-3 pb-0 d-flex justify-content-between">
                                        <div>
                                            ...
                                            <a href="whatsapp://send?text=={{ route('article', $article->title_slug) }}"
                                                target="_blank">
