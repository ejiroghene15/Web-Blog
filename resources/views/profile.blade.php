		...
		<div class="card profile-card border-0">
			<div class="tab-content" id="pills-tabContent">
				<section class="tab-pane fade show active text-center" id="display-profile" role="tabpanel"
					...
					<img src="{{ $profile->profilepix }}" height="120" width="120" class="rounded-circle"
					...
					<p>
						...
						<a href="{{$profile->facebook}}" class="mr-1" target="_blank"><img
								src="{{ asset('img/facebook.png') }}" alt="" height="25" width="25"></a>
						@endif
						@if (filled($profile->twitter))
						<a href="{{$profile->twitter}}" target="_blank"><img src="{{ asset('img/twitter.png') }}" alt=""
				...
				<section class="tab-pane fade" id="edit-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
					<form method="post" enctype="multipart/form-data" class="card-body">
						...
						<center id="img-container" class="mb-4 position-relative d-flex justify-content-center">
							<span class="fa-stack  position-absolute align-self-center text-dark"
						...
						<div class="form-group row" id="social-links">
							...
							<div class="col-sm-9">
								<div class="row">
									<div @unless(!empty($profile->facebook)) id="fb" @endunless class="col-sm-6
										pl-0">
									...
									<div @unless(!empty($profile->twitter)) id="tw" @endunless class="col-sm-6
										pl-0">
										<div class="input-group mb-3">
											<div class="input-group-prepend">
												<button class="btn bg-transparent border-0" type="button">
													<img src="{{ asset('img/twitter.png') }}" alt="" height="25"
														width="25">
												</button>
											</div>
						...
						<center><button type="submit" class="btn btn-success gh-btn" style="font-size: 16px">Update
